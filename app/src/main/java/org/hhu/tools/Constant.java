...
public class Constant {
	public static final byte[] COMM_QUERY_SENSER = {(byte) 0xC8};
	public static final byte[] COMM_LED_ON = {(byte) 0xC9};
	public static final byte[] COMM_LED_OFF = {(byte) 0xCA};
	public static final byte[] COMM_SET_HEATER = {(byte) 0xCB}; // any HEX exception 0xC8, 0xC9, 0xCA
